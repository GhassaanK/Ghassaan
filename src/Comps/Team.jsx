  ...
  return (
    <div className='container team sections' id='team'>
      ...
      <div className="card-container">
        ...
        <div className="card">
          <img className="card-img-top images" src={anas} alt="Card cap" />
        ...
        <div className="card">
          <img className="card-img-top images" src={ghassaan} alt="Card cap" />
          <div className="card-body">
        ...
        <div className="card">
          <img className="card-img-top images" src={wajdan} alt="Card cap" />
          <div className="card-body">
